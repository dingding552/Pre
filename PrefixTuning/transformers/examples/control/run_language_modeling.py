...
def main():
    ...
    if 'lowdata' in training_args.output_dir:
        ...
        print('！checkhere running evaluation on ', checkpoint_path)

        os.system('python /Users/dingdaren/thesis/PrefixTuning/transformers/examples/text-generation/gen.py webnlg yes yes {} no'.format(checkpoint_path)) # hard-written
