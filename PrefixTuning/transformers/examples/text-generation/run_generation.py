...
import sys, os
sys.path.insert(1, '/Users/dingdaren/thesis/PrefixTuning/transformers/examples/control')# change1
...
def main():
    ...
    if args.control_dataless == 'yes' or args.task_mode == 'dataless':
        ...
        if QUICK_CHECK:
            ...
            split_file = 'valid'
            decode_mode = 'beam'
            curr_dir = os.path.join('/Users/dingdaren/thesis/PrefixTuning/transformers/examples/text-generation/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file, decode_mode))
            print(curr_dir)
            gold_dir = os.path.join('/Users/dingdaren/thesis/PrefixTuning/transformers/examples/text-generation/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file,'gold'))
            print(gold_dir)
            write_e2e_corr(prompt_text_lst, prompt_text_dict, gold_dir)
            src_dir = os.path.join('/Users/dingdaren/thesis/PrefixTuning/transformers/examples/text-generation/',
                                   args.gen_dir,
        ...
        if args.task_mode == 'webnlg':
            ...
            test_path = "/Users/dingdaren/thesis/webnlg/webnlg-dataset/release_v2/json/test_sample.json" #change here
        ...
        if QUICK_CHECK:
            ...
            src_dir = os.path.join('/Users/dingdaren/thesis/PrefixTuning/transformers/examples/text-generation/',
                                   args.gen_dir,
                                   '{}_{}_{}'.format(temp, split_file, 'src'))
            # src_dir = '/Users/dingdaren/thesis/PrefixTuning/transformers/examples/text-generation/run_generation.py/wp_results/{}_{}_{}'.format(
            #     temp,
            #     split_file,
            #     'src')
            write_e2e_src(prompt_text_pair, src_dir)
        ...
        if QUICK_CHECK:
            ...
            split_file = 'test' # test
            decode_mode = 'nucleus'
            # curr_dir = '/Users/dingdaren/thesis/PrefixTuning/transformers/examples/text-generation/wp_results/{}_{}_{}'.format(
            #     temp, split_file, decode_mode)
            curr_dir = os.path.join('/Users/dingdaren/thesis/PrefixTuning/transformers/examples/text-generation/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file, decode_mode))
